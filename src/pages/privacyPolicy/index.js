    ...
    <div>
      ...
      <div className={`font-nunito max-w-[1400px] mx-auto px-[24px]`}>
        <div className="space-y-5 mb-[100px]">
          <h1 className="font-unbounded text-[36px] font-[600]">
            Политика конфиденциальности
          </h1>
          <h1 className="font-unbounded text-[24px] font-[600]">
            Обработка персональных данных
          </h1>
          <ul className="list-decimal space-y-8 w-[60%]">
            <li className="space-y-8">
              ...
              <p>
                ...
                персональных данных, предпринимаемые SMMFLOW (далее – Оператор).
              </p>
            ...
            <li className="space-y-8">
              ...
              <p>
                2.9. Пользователь – любой посетитель веб-сайта httpssmmflow.net;
              </p>
              <p>
            ...
            <li className="space-y-8">
              ...
              <p>
                ...
                информации иили материалам, содержащимся на веб-сайте.
              </p>
              <p>
                ...
                Оператору письмо на адрес электронной почты support@smmflow.net
            ...
            <li className="space-y-8">
              ...
              <p>
                ...
                только в случае их заполнения иили отправки Пользователем
                самостоятельно через специальные формы, расположенные на сайте
                httpssmmflow.net. Заполняя соответствующие формы иили отправляя
            ...
            <li className="space-y-8">
              ...
              <p>
                ...
                Оператора support@smmflow.net с пометкой «Актуализация
                персональных данных».
              </p>
              <p>
                ...
                support@smmflow.net с пометкой «Отзыв согласия на обработку
                персональных данных».
              </p>
            </li>
            <li className="space-y-8">
              ...
              <p>
                ...
                передачу его персональных данных иили исполнения договора,
            ...
            <li className="space-y-8">
              ...
              <p>
                ...
                сети Интернет по адресу httpssmmflow.netprivacy.
              </p>
            </li>
          </ul>
        </div>
