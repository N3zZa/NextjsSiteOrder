  ...
  return (
    <div className="font-nunito">
      ...
      <div className="absolute w-[61%] h-[72%]">
        <div className="fixed md:absolute z-50 p-5 w-[95%] h-[50%] md:w-auto bg-white md:right-0 bottom-0 md:bottom-0 rounded-2xl">
          <div className="flex flex-col space-y-5 items-center md:items-start">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-5 flex flex-col">
                ...
                <button
                  onClick={() => onShowRegMenuSecond()}
                  className="p-[14px] text-white bg-custom-orange rounded-2xl w-full"
                >
                  Сбросить пароль
                </button>
                <button
